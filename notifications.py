...
class Notifications:
    ...
    async def lesson_2_0(self):
        ...
        msg =   '<b>Почему мы уверены на 100%, что этот мини-курс бустанёт твои навыки и ты не'\
                ' пожалеешь о 490 рублях и времени, вложенных в него?</b>'\
                ...
                ' А наша академия Bonnie&Slide обучила больше 100 компаний, в числе которых такие'\
                ' гиганты как Х5, РЖД, Росгосстрах, Билайн, Газпром, Сбер, Пепси, Нестле, ПСБ и многие'\
                ' другие. 1839 сотрудников этих компаний выросли в Excel и Google Таблицах вместе с нами.'\
    ...
    async def lesson_2_2(self):
        builder = InlineKeyboardBuilder()
        msg =   'Кстати, о кейсах! Хотим поделиться с тобой короткой историей Марины Ерониной, она'\
                ' работает в сфере фармацевтики 💊'\
                ' \n<b>Вероника прошла наш флагманский курс и вот, что говорит о своих точках А и Б</b>:'\
                ...
                ' (🔥до сгорания первой жизни осталось 29 минут🔥)'
    ...
    async def lesson_2_5(self):
        builder = InlineKeyboardBuilder()
        msg =   'Текст:'\
                ' Чтобы работа со сводными таблицами и формулами действительно упрощала работу,'\
                ' нужно👇'\
    ...
    async def lesson_3_0(self):
        ...
        msg =   '<b>Мы перешли через экватор нашего курса</b>🚀'\
                ' \nОсталось ещё 2 мощных урока, сегодня мы переходим к уроку 3: "Вычисления: разные'\
                ' функции в области значений. Доли."'\
                ' \nБудем активно считать, как раз то, что нужно для твоих отчётов.'\
                ' \n\nСегодня ты научишься:'\
                ' \n• менять вычисление в области значений сводной (сумма, количество, среднее и другие'\
                ' функции);'\
                ' \n• вычислять несколькими способами по одному и тому же полю, например, сумма и'\
                ' среднее продаж;'\
                ' \n• считать уникальные значения: сколько наименований покупал каждый клиент,'\
                ' \n• сколько товаров (не единиц, а наименований!) хранится в каждом городе'\
    ...
    async def lesson_3_1(self):
        ...
        msg =   '<b>Вчера мы получили такой вопрос от одного из участников этого мини-курса:</b>'\
                ...
                ' \n\n<b>То есть смотри, точка А Надежды - базовые знания, а точка - горячие клавиши,'\
                ...
                ' подобрать для себя идеальную программу и формат❤'
    ...
    async def lesson_3_2(self):
        builder = InlineKeyboardBuilder()
        msg =   'Для нашего мини-курса мы не спроста выбрали тему, которая за 4 урока улучшит твою'\
    ...
    async def lesson_3_5(self):
        ...
        msg =   '<b>Почему тебе стоит дойти до конца этого курса?</b>🤔'\
                ...
                ' 02 Настраивать макет сводной таблицы, использовать группировку, фильтры и'\
                ' срезы'\
    ...
    async def lesson_4_5(self):
        ...
        msg =   '<b>У тебя осталось 12 часов на то, чтобы сохранить за собой самые выгодные условия'\
                ...
                ' \n\nВАЖНО: дополнительная скидка 10% держится 30 минут после просмотра финального урока,'\
                ' а твоя накопленная скидка держится 24 часа ⏱️'\
    ...
    async def lesson_4_8(self):
        ...
        msg =   'Ты уже сделал первый шаг, освоив базовые навыки работы со сводными таблицами, но это'\
                ' <i>только вершина айсберга'\
                ' \n<b>Те знания, которые ты можешь получить, могут кардинально изменить твою карьеру'\
                ' и подход к работе с данными.</i>'\
                ...
                ' \n💪🏻 Сокращение времени на подготовку отчетов с нескольких часов до нескольких минут'\
    ...
    async def lesson_4_10(self):
        ...
        msg =   '<b>К сожалению, твои бонусные монеты сгорели, а вместе с ними и твоя скидка...</b>'\
                ...
                ' слабые стороны. Заранее спасибо тебе за помощь, это бесценно❤'
