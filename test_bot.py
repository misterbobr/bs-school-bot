...
class TgBot:
    ...
    async def start_lessons(self, user_id, first_name, lk_url: str):
        ...
        lesson_timings = [
            ...
            [30,120,120,60,     30,180,180,360,180,180,1440],
            [1,59,120,120,     60,180,180,360,360,1440],
            [1,179,60,60,180,     240,600,120,      1440,1440,1440,2880,1440,2880,1440],
        ]
    ...
    def setup_handlers(self):
        ...
        ### stop command - remove user from running list
